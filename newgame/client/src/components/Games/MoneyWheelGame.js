...
function MoneyWheelGame() {
  ...
  const wheelSegments = [
    { value: 2, multiplier: 2, color: '#ff6b6b', label: '$2' },
    { value: 5, multiplier: 5, color: '#4ecdc4', label: '$5' },
    { value: 10, multiplier: 10, color: '#ffe66d', label: '$10' },
    { value: 20, multiplier: 20, color: '#a8e6cf', label: '$20' },
    { value: 50, multiplier: 50, color: '#ffd93d', label: '$50' },
  ...
  return (
    <div className="moneywheel-game-container">
      <GameHeader 
        title="💰 Money Wheel"
        balance={balance}
        backPath="/dashboard"
      ...
      <div className="moneywheel-main">
        <div className="moneywheel-game-layout">
          <div className="moneywheel-board">
          ...
          <div className="moneywheel-controls">
          ...
          <div className="rules-section">
            ...
            <div className="rules-content">
              <div className="rules-objective">
                <p><strong>Objective:</strong> Spin the money wheel and win cash prizes based on the multiplier you land on.</p>
              </div>
                ...
                {rulesTab === 'howtoplay' && (
                  <div className="tab-panel">
                    <ul>
                      ...
                      <li>Click "Spin Wheel" to spin the money wheel</li>
                ...
                {rulesTab === 'payouts' && (
                  <div className="tab-panel">
                    <ul>
                      ...
                      <li><strong>$50 Segment:</strong> 50x your bet</li>

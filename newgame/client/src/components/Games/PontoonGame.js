...
import './PontoonGame.css';

function PontoonGame() {
  const { user, fetchUser } = useAuth();
  const { showError, showInsufficientBalance } = useNotification();
  const navigate = useNavigate();
  const [settings, updateSettings] = useGameSettings('pontoon', {
    bet: 5,
    rulesTab: 'howtoplay'
  });
              ...
              <div className="game-rules">
                ...
                <div className="rules-content">
                  <div className="rules-objective">
                    <p><strong>Objective:</strong> British blackjack variant. Get closer to 21 than the dealer.</p>
                  </div>
                  ...
                  <div className="rules-tab-content">
                    {rulesTab === 'howtoplay' && (
                      <div className="tab-panel">
                        <ul>
                          <li>British blackjack variant</li>
                          <li>Get closer to 21 than dealer</li>
                          <li>Pontoon (21) always wins</li>
                          <li>Five-card trick beats 21</li>
                        </ul>
                      </div>
                    )}
                    {rulesTab === 'payouts' && (

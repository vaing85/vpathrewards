...
import './Spanish21Game.css';

function Spanish21Game() {
  const { user, fetchUser } = useAuth();
  const { showError, showInsufficientBalance } = useNotification();
  const navigate = useNavigate();
  const [settings, updateSettings] = useGameSettings('spanish21', {
    bet: 5,
    rulesTab: 'howtoplay'
  });
              ...
              <div className="game-rules">
                ...
                <div className="rules-content">
                  <div className="rules-objective">
                    <p><strong>Objective:</strong> Get closer to 21 than the dealer using a Spanish deck (no 10s).</p>
                  </div>
                  ...
                  <div className="rules-tab-content">
                    {rulesTab === 'howtoplay' && (
                      <div className="tab-panel">
                        <ul>
                          <li>Spanish deck (no 10s)</li>
                          <li>Get closer to 21 than dealer</li>
                          <li>Blackjack pays 3:2</li>
                          <li>Player 21 always wins</li>
                        </ul>
                      </div>
                    )}
                    {rulesTab === 'payouts' && (

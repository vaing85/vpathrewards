...
function FruitSlotsGame() {
  const { user, fetchUser } = useAuth();
  const { showError, showInsufficientBalance } = useNotification();
  const navigate = useNavigate();
  const [settings, updateSettings] = useGameSettings('fruitslots', {
    bet: 5,
    rulesTab: 'howtoplay'
  });
          ...
          <div className="rules-section">
            ...
            <div className="rules-content">
              <div className="rules-objective">
                <p><strong>Objective:</strong> Spin the reels and match fruit symbols to win prizes. Three matching symbols win!</p>
              </div>
                ...
                {rulesTab === 'howtoplay' && (
                  <div className="tab-panel">
                    <ul>
                      ...
                      <li>Match three fruit symbols to win</li>
                      <li>Different fruits have different payout multipliers</li>
                      <li>Rare fruits pay more</li>
                    </ul>
                  </div>
                )}
                ...
                {rulesTab === 'payouts' && (
                  <div className="tab-panel">
                    <ul>
                      ...
                      <li><strong>Three Common Fruits:</strong> Standard payout</li>

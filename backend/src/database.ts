...
export const initDatabase = async () => {
  ...
  try {
    ...
    // E-file.com — online tax filing service (Tax Services category)
    // Commission rates to be confirmed against CJ program terms
    await seedMerchantsOffers(
      ...
      [
        { title: 'Start Filing Your Taxes Here', description: 'File your taxes online quickly and easily at E-file.com — one of the most affordable e-filing services available.', affiliate_url: 'https://www.jdoqocy.com/click-101708885-11917138', cashback_rate: 10, commission_rate: 20 },
        { title: 'E-file a State Tax Return', description: 'File your state tax return online in minutes with E-file.com. Fast, secure, and affordable.', affiliate_url: 'https://www.jdoqocy.com/click-101708885-11917140', cashback_rate: 10, commission_rate: 20 },
        { title: 'IRS Tax Returns — File Online', description: 'Prepare and e-file your IRS federal tax return online at E-file.com. Guaranteed accurate and secure.', affiliate_url: 'https://www.kqzyfj.com/click-101708885-11917161', cashback_rate: 10, commission_rate: 20 },
        { title: 'IRS Tax Filing at E-file.com', description: 'E-file your IRS taxes online with confidence. Simple step-by-step guidance from E-file.com.', affiliate_url: 'https://www.jdoqocy.com/click-101708885-11917158', cashback_rate: 10, commission_rate: 20 },
        { title: 'Compare Tax Providers — E-file.com', description: 'See why E-file.com beats the competition on price. Compare top tax filing providers side by side.', affiliate_url: 'https://www.anrdoezrs.net/click-101708885-11917148', cashback_rate: 10, commission_rate: 20 },
        { title: '$10 Off State Filings — Coupon Code 10OFFSTATE', description: 'Save $10 on your state tax filing when you use coupon code 10OFFSTATE at E-file.com.', affiliate_url: 'https://www.tkqlhce.com/click-101708885-11917143', cashback_rate: 10, commission_rate: 20 },
        { title: '20% Off Tax Filing at E-file.com', description: 'Save 20% on your federal and state tax filings at E-file.com. Fast, easy, and secure.', affiliate_url: 'https://www.tkqlhce.com/click-101708885-11917170', cashback_rate: 10, commission_rate: 20 },
        { title: '50% Cheaper Tax Filing — E-file.com', description: 'E-file.com is up to 50% cheaper than other major tax filing services. File smarter, save more.', affiliate_url: 'https://www.anrdoezrs.net/click-101708885-11917145', cashback_rate: 10, commission_rate: 20 },
        { title: '50% Cheaper E-filing — Switch to E-file.com', description: 'Switch to E-file.com and save up to 50% on your tax e-filing compared to other providers.', affiliate_url: 'https://www.tkqlhce.com/click-101708885-11917147', cashback_rate: 10, commission_rate: 20 },
        { title: 'Compare E-file Providers — E-file.com', description: 'Compare e-file providers and see why thousands choose E-file.com for their annual tax filing.', affiliate_url: 'https://www.tkqlhce.com/click-101708885-11917150', cashback_rate: 10, commission_rate: 20 },
        { title: 'File Your IRS Taxes Online — E-file.com', description: 'Quickly and securely file your IRS taxes online at E-file.com. Step-by-step guidance included.', affiliate_url: 'https://www.tkqlhce.com/click-101708885-11917163', cashback_rate: 10, commission_rate: 20 },
        { title: 'E-file IRS Taxes — E-file.com', description: 'E-file your IRS taxes with ease. Accurate calculations and maximum refund guaranteed.', affiliate_url: 'https://www.tkqlhce.com/click-101708885-11917162', cashback_rate: 10, commission_rate: 20 },
        { title: 'E-file Your Tax Return Today', description: 'Stop procrastinating — e-file your tax return today at E-file.com and get your refund faster.', affiliate_url: 'https://www.jdoqocy.com/click-101708885-17012252', cashback_rate: 10, commission_rate: 20 },
        { title: 'Save 20% at E-file.com', description: 'Get 20% off your tax filing at E-file.com. The affordable way to file federal and state returns.', affiliate_url: 'https://www.anrdoezrs.net/click-101708885-11917168', cashback_rate: 10, commission_rate: 20 },
        { title: '20% Off With Coupon Code SAVE24', description: 'Use coupon code SAVE24 at E-file.com to save 20% on your tax filing this season.', affiliate_url: 'https://www.jdoqocy.com/click-101708885-11917173', cashback_rate: 10, commission_rate: 20 },
        { title: 'File Your IRS Taxes Free — E-file.com Basic', description: 'Qualify for free federal filing with E-file.com Basic. Simple returns filed at no cost.', affiliate_url: 'https://www.kqzyfj.com/click-101708885-17233815', cashback_rate: 10, commission_rate: 20 },
      ]
    );

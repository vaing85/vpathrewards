  ...
  const handlePlay = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_URL}/games/caribbeanstud/play`,
        { bet },
        { headers: { Authorization: `Bearer ${token}` } }
      );

      // Generate random cards for display (5 cards for Caribbean Stud Poker)
      const suits = ['♠', '♥', '♦', '♣'];
              ...
              <div className="game-rules">
                ...
                <div className="rules-content">
                  <div className="rules-objective">
                    <p><strong>Objective:</strong> Make the best 5-card poker hand to beat the dealer.</p>
                  </div>
                  ...
                  <div className="rules-tab-content">
                    {rulesTab === 'howtoplay' && (
                      <div className="tab-panel">
                        <ul>
                          ...
                          <li>You receive 5 cards</li>
                          <li>Dealer must have Ace-King or better</li>
                          <li>Best hand wins</li>
                          <li>Progressive jackpots available</li>
                        </ul>
                      </div>
                    )}
                    {rulesTab === 'rankings' && (
                    ...
                    {rulesTab === 'payouts' && (
                      <div className="tab-panel">
                        <ul>
                          <li>Win chance: 35%</li>
                          <li>Multipliers: 1x to 50x</li>
                          <li>Progressive jackpot available</li>

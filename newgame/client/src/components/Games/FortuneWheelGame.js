...
function FortuneWheelGame() {
  ...
  const wheelSegments = [
    ...
    { multiplier: 20, color: '#a8e6cf', label: '×20' },
    { multiplier: 100, color: '#ffd93d', label: '×100' },
  ...
  const performSpin = async () => {
    try {
      ...
      const response = await axios.post(
        `${API_URL}/games/fortunewheel/play`,
        { bet },
  ...
  return (
    <div className="fortunewheel-game-container">
      <GameHeader 
        title="🎰 Fortune Wheel"
        balance={balance}
        backPath="/dashboard"
      ...
      <div className="fortunewheel-main">
        <div className="fortunewheel-game-layout">
          <div className="fortunewheel-board">
          ...
          <div className="fortunewheel-controls">

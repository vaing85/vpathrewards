...
function DiamondSlotsGame() {
  const { user, fetchUser } = useAuth();
  const { showError, showInsufficientBalance } = useNotification();
  const navigate = useNavigate();
  const [settings, updateSettings] = useGameSettings('diamondslots', {
    bet: 5,
    rulesTab: 'howtoplay'
  });
  ...
  const performSpin = async () => {
    try {
      ...
      const response = await axios.post(
        `${API_URL}/games/diamondslots/play`,
        { bet },
          ...
          <div className="rules-section">
            ...
            <div className="rules-content">
              <div className="rules-objective">
                <p><strong>Objective:</strong> Spin the reels and match diamond symbols to win prizes. Three matching symbols win!</p>
              </div>
                ...
                {rulesTab === 'howtoplay' && (
                  <div className="tab-panel">
                    <ul>
                      ...
                      <li>Match three diamond symbols to win</li>
                      <li>Different gems have different payout multipliers</li>
                      <li>Rare gems pay more</li>
                    </ul>
                  </div>
                )}
                ...
                {rulesTab === 'payouts' && (
                  <div className="tab-panel">
                    <ul>
                      ...
                      <li><strong>Three Common Gems:</strong> Standard payout</li>
...
export default DiamondSlotsGame;
